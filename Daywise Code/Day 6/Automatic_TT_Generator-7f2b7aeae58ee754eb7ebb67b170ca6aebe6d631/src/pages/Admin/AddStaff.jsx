...
const AddStaff = () => {
  ...
  return (
    <div className='font-mono h-screen mt-[4vh] mx-4 overflow-hidden'>
     ...
     <div className='flex flex-col justify-center items-center'>
        ...
        <div className='font-mono flex flex-col gap-5'>
          ...
          <div className="flex items-center">
            <Label className="w-2/4 text-[15px]">Enter Department</Label>
            <input
              type="text"
              value={staffEmail}
          ...
          <div className="flex items-center">
            <Label className="w-2/4 text-[15px]">Enter Staff Email</Label>
            <input
              type="text"
              value={staffEmail}
